...
function run(L,n,order,Δt,t₀,T,Pe,τᵈkₒ)
  ...
  savefig(plt,"plots/actinmodel/u_Pe_$(trunc(Pe,digits=2))_r_$(trunc(τᵈkₒ,digits=2)).png")
  plt = heatmap(sx,st,kymograph_e,c=:jet,yflip=true,yticks=(0.0:0.2:1.0,string.(0.0:0.2:1.0)),size=(600,600))
  savefig(plt,"plots/actinmodel/e_Pe_$(trunc(Pe,digits=2))_r_$(trunc(τᵈkₒ,digits=2)).png")
